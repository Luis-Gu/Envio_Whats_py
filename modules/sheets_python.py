...
class SheetsPython:
    ...
    def update_sheets_data(self, data_frame : DataFrame,
                                 ...
                                 append : bool = False,
                                 append_col_ref : str | None = None,
                                 zuq_model : bool = False) -> None:
        ...
        if zuq_model:
            sheet.values().append(
                ...
                range=range_sheets,  # A primeira célula de onde começar o append (por exemplo, "Sheet1!A1")
                valueInputOption='USER_ENTERED',
                insertDataOption='OVERWRITE',  # Adiciona novas linhas para inserir os dados
        ...
        if append and append_col_ref is not None:
            ...
            data_from_ref_col = self.get_data_from_sheets(id_sheets=id_sheets,
                                                          range_sheets=range_ref,with_headers=False)
